            ...
            <div class="row mt-4">
                <div class="col-sm-6 col-12">
                    <div class="bg-white py-3">
                        ...
                        <div class="col">
                            <p class="parrafo-proyecto">Wordpress,Illustrator,Photoshop,Premiere,After effects,Dreamweaver,3DS max,Sony Vegas,Xampp,Git,Github,Trello,Slack,Visual Code,Sublime,Paquete office</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-12 mt-sm-0 mt-4">
